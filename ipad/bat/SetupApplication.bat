...
:: Android packaging
set AND_CERT_NAME="Mozzarella"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\Mozzarellaios.p12
...
set IOS_DEV_CERT_PASS=/G4m1ngF0ndu3
set IOS_PROVISION=cert\mozzarella_ios.mobileprovision
...
set APP_ID=com.angrymole.mozzarella

:: Output packages
set DIST_PATH=dist
set DIST_NAME=Mozzarella
